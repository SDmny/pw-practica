...
if (pagina.includes("servicios")) {
  var servicios = [
    ...
    { nombre: "App Movil", desc: "Android", precio: 2500, img: "images/AppMovil.png" },
    {
      ...
      desc: "Ciberseguridad",
      precio: 1800,
      img: "images/Seguridad.jpeg",
    },
    { nombre: "Servidor", desc: "Servidor", precio: 2200, img: "images/Servidor.jpeg" },
    { nombre: "Linux", desc: "Admin Linux", precio: 900, img: "images/Linux.jpeg" },
    {
      nombre: "Consultoria",
      desc: "Asesoria",
      precio: 1100,
